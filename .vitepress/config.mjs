...
export default defineConfig({
  base: "/VitePress-demo/",
  title: "かく郭琦",
  head: [['link', { rel: 'icon', href: 'https://qingchuntai2.oss-cn-beijing.aliyuncs.com/qct/favicon.ico' }]],
      ...
      "/src/insight/essay/": [
        {
          text: "随笔",
          items: [
            { text: "简介", link: "/src/insight/essay/home" },
            { text: "大宅门", link: "/src/insight/essay/dazhaimen" },
          ],
        },
      ],
